...
architecture STRUCT_PDLCFG of PDLCFG is
component PWR
...
begin
 ...
 port map(RCLKS => RCLOCK, WCLKS => WCLOCK, DO8 => PO, DO7 => DO(7), DO6 => DO(6), 
      DO5 => DO(5), DO4 => DO(4), DO3 => DO(3), DO2 => DO(2), DO1 => DO(1), 
      DO0 => DO(0), DOS => net00011, WADDR7 => net00001, WADDR6 => net00001, WADDR5 => WADDR(5), 
      WADDR4 => WADDR(4), WADDR3 => WADDR(3), WADDR2 => WADDR(2), WADDR1 => WADDR(1), 
      WADDR0 => WADDR(0), RADDR7 => net00001, RADDR6 => net00001, RADDR5 => RADDR(5), RADDR4 => RADDR(4), 
...
-- MGNTIMER:F
-- MGNCMPL:F
-- "DESDIR:C:/FrontEnd/Annalisa/work/vx1392/smartgen\PDLCFG"
-- GEN_BEHV_MODULE:F
--  WIDTH:8
--  DEPTH:48
--  RDA:transparent
